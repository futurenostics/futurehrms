...
export const legacySkipList = [
  ...
  // 'components/ui/form.tsx' — remediated in Sub-phase B Tier 6.
  ...
  // 'components/ui/table.tsx' — remediated in Sub-phase B Tier 7.
  // 'components/ui/tabs.tsx' — remediated in Sub-phase B Tier 5.
