...
const buttonVariants = cva(
  // Pointer cursor on hover, not-allowed when disabled; transitions tuned
  // to 150ms ease; visible focus-ring uses --fn-accent over the page bg.
  'focus-visible:ring-fn-accent focus-visible:ring-offset-fn-bg inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      variant: {
