...
export const EXPENSE_COPY = {
  ...
  alertPendingTitle: 'Pending',
  alertPendingBody: 'Waiting on Finance.',
  alertApprovedTitle: 'Approved',
  alertApprovedBody: 'This claim was approved.',
  alertRejectedTitle: 'Rejected',
  alertRejectedNoReason: 'No reason given.',
  alertReturnedTitle: 'Returned',
  alertReturnedBody: 'Update this claim and submit again.',
  lastActionBy: 'by',
